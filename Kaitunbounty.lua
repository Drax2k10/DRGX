loadstring(game:HttpGet("https://raw.githubusercontent.com/Drax2k10/DRGX/refs/heads/main/deleteoldgui.lua"))()                     repeat task.wait() until game:IsLoaded()
...
_G.SeleneCFG = {
    ...
    WebhookURL    = "",
    DiscordID     = "",
    SuperBoostFps      = false, -- setting false if want see all
}
